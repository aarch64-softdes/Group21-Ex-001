...
public enum ErrorCode {
    // System Errors
    UNCATEGORIZED("Uncategorized Exception"), INVALID_ERROR_KEY("Invalid error key"),
    FAIL_TO_EXPORT_FILE("Failed to export file"), FAIL_TO_IMPORT_FILE("Failed to import file"),
    ...
    FIELD_REQUIRED("{field} must be filled in"), UNENROLLABLE_COURSE("Unenrollable course"),
    ...
    STUDENT_PREREQUISITES_NOT_SATISFIED(
            "Student has not passed the necessary prerequisite subjects"),

    // Course Errors
    INVALID_COURSE_SCHEDULE_TIME("Invalid course schedule time"),
    // Resource Errors
    NOT_FOUND("Resource not found"), DUPLICATE_RESOURCE("Resource already existed"),
