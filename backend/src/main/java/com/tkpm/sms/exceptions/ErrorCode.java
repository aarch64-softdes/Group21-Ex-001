...
public enum ErrorCode {
    ...
    NUMBER_REQUIRED("Number is required", HttpStatus.BAD_REQUEST),
    ISSUED_BY_REQUIRED("Issued by is required", HttpStatus.BAD_REQUEST),
    ISSUED_DATE_REQUIRED("Issued date is required", HttpStatus.BAD_REQUEST),
