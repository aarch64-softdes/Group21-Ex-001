...
ALTER TABLE enrollments
    ADD CONSTRAINT uc_enrollments_transcript UNIQUE (transcript_id);
...
ALTER TABLE enrollments
    ADD CONSTRAINT FK_ENROLLMENTS_ON_TRANSCRIPT FOREIGN KEY (transcript_id) REFERENCES transcripts (id);
...
('CS101_01', 2025, 1, 'Dr. John Smith', 40, 'A101', 'T2(3-6)', '2025-01-15', 1, 1),
('CS101_02', 2025, 1, 'Dr. Sarah Johnson', 35, 'B202', 'T4(1-4)', '2025-01-15', 1, 1),
('CS201_01', 2025, 1, 'Dr. Emily Chen', 45, 'A105', 'T5(4-7)', '2025-01-17', 1, 2),
('CS301_01', 2025, 1, 'Prof. Robert Davis', 30, 'C303', 'T3(1-4)', '2025-01-16', 1, 3),
...
-- Insert sample transcript records
INSERT INTO transcripts ( grade, gpa) VALUES 
    ( 'A', 3.8),
    ( 'B+', 3.4),
    ( 'C', 2.9);

-- Insert sample enrollment records referencing the transcript records
INSERT INTO enrollments (student_id, course_id, transcript_id) VALUES 
    ('ST001_ID', 1, 1),
    ('ST002_ID', 2, 2),
    ('ST003_ID', 3, 3);
...
INSERT INTO histories (id, action_type, created_at, student_id, course_id) VALUES 
    ('HIST001', 'Enrollment', '2025-01-15 10:00:00', 'ST001_ID', 1),
    ('HIST002', 'Grade Update', '2025-06-15 12:00:00', 'ST002_ID', 2),
    ('HIST003', 'Course Drop', '2025-07-20 14:30:00', 'ST003_ID', 3);